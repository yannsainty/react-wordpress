...
export class ChambreMini extends Component {
    ...
    render() {  
        ...
        if (infos === null) {
            ...
            return (
                <div className="container nos_chambres_une" id="nos_chambre_top">
                    <div className="row">
                                        ...
                                        <div className="col-md-5 order-first">
                                            <div className="container_chambre_infos">										
                                                ...
                                                <div className="chambre_texte right">
                                                    ...
                                                    <img className="chambre_picto_left" id="chambre_picto_top" src={require(`../components/img/chambre_picto_mini.png`)} />
                                                </div>
