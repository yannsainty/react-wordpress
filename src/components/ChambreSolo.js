...
export class ChambreSolo extends Component {
                                        ...
                                        <div className="col-md-5">
                                            <div className="container_chambre_infos">										
                                                ...
                                                <div className="chambre_texte right">
                                                    ...
                                                    <img className="chambre_picto_right" src={require(`../components/img/chambre_picto_solo.png`)} />
                                                </div>
